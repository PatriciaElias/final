<%-- 
    Document   : ruinas
    Created on : 11 nov 2022, 20:58:29
    Author     : Edwin
--%>
...
<html>
    ...
    <body>
                ...
                <section id="actions" class="py-4 mb-4 bg-ligth">
                    <div class="col md-3" >
                        <a href="#" class="btn btn-primary btn-block"
                           data-bs-toggle="modal" data-bs-target="#agregarRuinaModal">
                            <i class="fa fa-plus"></i>Agregar ruinas
                        </a>
                    </div>
                </section>
            </center>
        ...
        <jsp:include page="WEB-INF/paginas/ruinas/listadoRuinas.jsp"/>
