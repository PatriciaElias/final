<%-- 
    Document   : balneariosListU
    Created on : 10 nov. 2022, 11:19:18
    Author     : MINEDUCYT
--%>
...
<html >
    ...
    <body style="background: rgb(8, 63, 129);
        ...
        <br><br><br><br>
        <div class="col-12">
            <img src="imagenes/cabecera_balneario.jpg"class=" mx-auto img-fluid mg-responsive">
        </div><br>

        <!--INCLUYE EL JSP DEL LISTADO DE BALNEARIOS-->
