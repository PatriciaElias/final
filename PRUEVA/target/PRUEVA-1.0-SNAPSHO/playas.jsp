...
<html>
    ...
    <body>
                ...
                <section id="actions" class="py-4 mb-4 bg-ligth">
                    <div class="col md-3" >
                        <a href="#" class="btn btn-primary btn-block"
                           data-bs-toggle="modal" data-bs-target="#agregarPlayaModal">
                            <i class="fa fa-plus"></i>Agregar playa
                        </a>
                    </div>
                </section>
            </center>
        ...
        <jsp:include page="WEB-INF/paginas/playas/listadoPlayas.jsp"/>
