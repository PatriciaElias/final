<div class="modal fade" id="agregarMiradorModal">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary bg-gradient text-white">
                <i class="fa-solid fa-binoculars"></i><h5 class="modal-title">. Agregar Mirador</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="${pageContext.request.contextPath}/ServletControladorMirador?accion=insertar"
                  method="post" class="was-validated" enctype="multipart/form-data">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="id_categorias">Categoria:</label>
                        <!--EL VALUE DE LA CATEGORIA CAMBIA SEGUN LA TABLA-->
                        <input type="text" class="form-control" name="id_categorias"  readonly  placeholder="Miradores"required>
                    </div>
                    <div class="form-group">
                        <label for="nombre_volcan">Nombre:</label>
                        <input type="text" class="form-control" name="nombre_mirador" required>
                    </div>
                    <div class="form-group">
