        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-header text-white table-responsive">
                    ...
                    <c:forEach var="pla" items="${listaPlaya}" varStatus="status">
                        <table class="table table-borderless  abs-center text-white align-middle " style="background-color: rgba(0, 0, 0, 0.1);
                            ...
                            <tbody class="">
                                <td class="col-1" style>
                                    <h3>${status.count} <i class="fa-solid fa-volleyball fa-spin"></i></h3>
                                </td>
                                <td colspan="2" class="">

                                    <h6 class="text-info">Nombre:</h6>
                                    <h4>${pla.nombre_playa}</h4>
                                </td>
                                <td rowspan="4" class="col-5"><img src="ControlerIMGPlaya?id_playas=${pla.id_playas}"class="rounded-3 mx-auto" width="450" height="300"></td>
                                </tr>
                                <tr>
                                <td colspan="2">
                                    <h6 class="text-info">Departamento:</h6>
                                    <h5>${pla.nombre_departamento}</h5>
                                </td>
                                <td>
