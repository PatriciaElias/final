        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-header text-white table-responsive">
                    ...
                    <c:forEach var="mon" items="${listaMontania}" varStatus="status">
                        <table class="table table-borderless  abs-center text-white align-middle " style="background-color: rgba(0, 0, 0, 0.1);
                            ...
                            <tbody class="">
                                ...
                                <td class="col-1" style>
                                    <h3>${status.count} <i class="fa-solid fa-mountain-sun"></i></h3>
                                ...
                                <td rowspan="4" class="col-5"><img src="ControlerIMGMontania?id_montanias=${mon.id_montanias}" class="rounded-3 mx-auto" width="450" height="300"></td>
                                </tr>
                                <tr>
                                <td colspan="2">
                                    <h6 class="text-info">Departamento:</h6>
                                    <h5>${mon.nombre_departamento}</h5>
                                </td>
                                <td>
