<%-- 
    Document   : Volcanes
    Created on : 13 nov 2022, 18:15:35
    Author     : Edwin
--%>
...
<html>
    ...
    <body>
                ...
                <section id="actions" class="py-4 mb-4 bg-ligth">
                    <div class="col md-3" >
                        <a href="#" class="btn btn-primary btn-block"
                           data-bs-toggle="modal" data-bs-target="#agregarVolcanModal">
                            <i class="fa fa-plus"></i>Agregar Volcan
                        </a>
                    </div>
                </section>
            </center>
        ...
        <jsp:include page="WEB-INF/paginas/volcanes/listadoVolcanes.jsp"/>
