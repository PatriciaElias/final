        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-header text-white table-responsive">
                    ...
                    <c:forEach var="cated" items="${listaCatedral}" varStatus="status">
                        <table class="table table-borderless  abs-center text-white align-middle " style="background-color: rgba(0, 0, 0, 0.1);
                            ...
                            <tbody class="">
                                ...
                                <td class="col-1" style>
                                    <h3>${status.count} <i class="fa-solid fa-church"></i></h3>                                    
                                </td>
                                <td colspan="2" class="">
                                ...
                                <td rowspan="4" class="col-5"><img src="ControlerIMGCatedral?id_catedrales=${cated.id_catedrales}"class="rounded-3 mx-auto" width="450" height="300"></td>
                                </tr>
                                <tr>
                                <td colspan="2">
                                    <h6 class="text-info">Departamento:</h6>
                                    <h5>${cated.nombre_departamento}</h5>
                                </td>
                                <td>
                                    <h6 class="text-info">Municipio:</h6>
                                    <h5>${cated.municipio}</h5>
                                </td>
                                </tr>
                                <tr>
                                <td colspan="3">
                                    <h6 class="text-info">Direccion:</h6>
                                    <h5>${cated.direccion}</h5>
                                </td>
                                </tr>
                                <tr>
                                <td colspan="3" class="">
                                    <h6 class="text-info">Descripcion:</h6>
                                    <h5>${cated.descripcion}</h5>
                                </td>
                                </tr>
                            </tbody>
                        </table> 
