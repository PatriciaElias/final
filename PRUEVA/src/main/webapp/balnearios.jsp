<%-- 
    Document   : balnearios
    Created on : 10 nov. 2022, 11:18:50
    Author     : MINEDUCYT
--%>
...
<html>
    <head>
        ...
        <title>Balnearios SV Admin</title>
    ...
    <body>
                ...
                <section id="actions" class="py-4 mb-4 bg-ligth">
                    <div class="col md-3" >
                        <a href="#" class="btn btn-primary btn-block"
                           data-bs-toggle="modal" data-bs-target="#agregarBalnearioModal">
                            <i class="fa fa-plus"></i>Agregar balneario
                        </a>
                    </div>
                </section>
            </center>
        ...
        <jsp:include page="WEB-INF/paginas/balnearios/listadoBalnearios.jsp"/>
